...
const StockInputForm: React.FC<StockInputFormProps> = React.memo(({
  ...
  return (
    <div className="bg-gray-800 p-6 rounded-lg shadow-xl mb-6">
      <h2 className="text-2xl font-semibold mb-6 text-center text-blue-300">Investment Configuration</h2>
      ...
      <div className="mb-6">
        ...
        <input
          ...
          min="0"
          step="any"
          className="w-full p-3 border border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out bg-gray-700 text-gray-100 placeholder-gray-400"
          placeholder="e.g., 10000"
        />
      </div>

      <div className="mb-6">
        <h3 className="text-xl font-medium mb-4 text-blue-300">Add New Stock</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          <div>
            <label htmlFor="stockName" className="block text-xs font-medium text-gray-300 mb-1">
              Stock Name
            </label>
            <input
              type="text"
              ...
              className="w-full p-3 border border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500 bg-gray-700 text-gray-100 placeholder-gray-400"
              placeholder="e.g., GOOGL"
            />
          </div>
          <div>
            <label htmlFor="stockPrice" className="block text-xs font-medium text-gray-300 mb-1">
              Price per Share ($)
            </label>
            <input
              type="number"
          ...
          <div>
            <label htmlFor="stockReturn" className="block text-xs font-medium text-gray-300 mb-1">
              Expected Return (%)
            </label>
            <input
              type="number"
      ...
      <div className="mt-8 pt-6 border-t border-gray-700">
        <h3 className="text-xl font-medium mb-4 text-blue-300">Generate Stock Ideas <span className="text-base text-gray-400">(AI Powered)</span></h3>
        <div className="flex flex-col md:flex-row gap-4">
          <input
            ...
            className="flex-grow p-3 border border-gray-600 rounded-md focus:ring-purple-500 focus:border-purple-500 transition duration-150 ease-in-out bg-gray-700 text-gray-100 placeholder-gray-400"
